package com.prediction.HMM.HMMs;


public class BakisHMM extends HMM {
	...
	public BakisHMM(String name, double[][] stateTransitProbMatrix, double[][] emissionProbMatrix, double[] piMatrix) {
